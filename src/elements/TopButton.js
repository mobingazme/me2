    ...
    <ScrollLink
      ...
      <div className='z-50'>
        <button
          ...
          className={`flex items-center  fixed bottom-8 left-8 justify-center w-14  duration-700   bg-gradient-to-r hover:bg-gradient-to-l  ease-in  from-[#10509f]   via-[#cf6dd8] to-[#ec82bc]  hover:w-28 h-14  rounded-full p-2 shadow-none border-none  transition-all ${isVisible ? 'visible animate__bounceInUp animate__animated animate__delay-2s' : 'hidden animate__bounceOut animate__animated animate__delay-2s'}`}>
