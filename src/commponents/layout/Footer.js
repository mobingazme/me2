...
function Footer() {
  return (
    <div className="footer  text-center   p-5 my-32 md:my-0 w-full h-fit md:p-20 -z-10 grid grid-cols-1 md:flex md:justify-center max-w-8xl items-center  shadow-lg "   >
