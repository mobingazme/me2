...
function Header() {
  ...
  return (
    <div className={`w-full h-fit flex items-center relative justify-between  p-2 md:p-7 `}>
      ...
      <div className={` flex items-center justify-between  md:p-10 w-full md:w-[1000px] transition-colors md:mx-28 h-16 p-5 z-50  ${isVisible ? 'backdrop-blur-sm bg-[#0000006]   rounded-md  fixed top-4  animate__animated animate__zoomInUp ' : 'animate__fadeInDown animate__animated'}`}>
      ...
      <div  id='1' className='absolute top-0 md:top-5   '>
        <ThreeDMoon />
      </div>
    </div>
  )
