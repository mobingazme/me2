...
function Header() {
  ...
  return (
    <div className={`w-full h-fit flex items-center relative justify-between  p-2 md:p-7 `}>
      ...
      <div className={` flex items-center justify-between p-5 md:p-10 w-full md:w-[1000px] transition-colors md:mx-28 h-16  z-50 ${isVisible ? 'backdrop-blur-sm bg-[#0000006] my-2 rounded-md overflow-hidden fixed mt-20 animate__animated animate__zoomInUp ' : 'animate__bounceInRight animate__animated'}`}>
