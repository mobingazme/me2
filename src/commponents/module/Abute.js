        ...
        <div id="abute" className=' w-full  flex items-center  md:px-20 py-40 relative'>
            <div className='  backdrop-blur-sm bg-[#0000006] grid grid-cols-1 md:flex  items-center justify-center w-full h-fit md:h-80 '>
                ...
                <div className=' p-4'>
                    ...
                    <p data-aos="fade-up" data-aos-duration="1500" data-aos-easing="ease-in-sine" className=' mb-1 md:mb-3 text-center md:text-start text-white'>از دو سال پیش، یادگیری برنامه‌نویسی را آغاز کرده‌ام. منابع اصلی یادگیری من شامل وب‌سایت‌هایی مانند <span className='text-gradient  duration-700 ease-in transition-all transform  md:hover:text-lg font-bold cursor-pointer'><Link href='https://roocket.ir'> roocket </Link></span>
